...
app.include_router(criteria.talent_router)
app.include_router(criteria.requirement_group_router)
app.include_router(criteria.requirement_router)
app.include_router(criteria.learning_unit_router)
